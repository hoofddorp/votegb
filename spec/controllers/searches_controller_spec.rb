...
#        post :create, {:search => { "name" => "invalid value" }}, valid_session
#        assigns(:search).should be_a_new(Search)
#      end
#
...
#        Search.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
#        put :update, {:id => search.to_param, :search => { "name" => "MyString" }}, valid_session
#      end
#
#      it "assigns the requested search as @search" do
#        search = Search.create! valid_attributes
...
#        # Trigger the behavior that occurs when invalid params are submitted
#        Search.any_instance.stub(:save).and_return(false)
#        put :update, {:id => search.to_param, :search => { "name" => "invalid value" }}, valid_session
#        assigns(:search).should eq(search)
#      end
#
